...
# 1. Load the probe we just trained
...
for name, prompt in conditions:
    ...
    # Project the high-dimensional vector onto the probe's learned direction
    # This turns the complex AI brain data into a single number: "How Sovereign is this?"
    projection = np.dot(layer_vectors, probe_weights.T)
...
# We check if the edge exists in our discovered graph
